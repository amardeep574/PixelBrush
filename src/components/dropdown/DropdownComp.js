...
// const DropdownComp = ({ title, fields, onValuesChange }) => {
...
//     onValuesChange(title, { ...updatedValues, total: sum.toFixed(2), 'final total': final.toFixed(2) });
//   };
...
//                     ? total // Non-editable
//                     : item === 'final total'
//                     ? finalTotal // Non-editable
//                     : values[item] || '' // Editable
//                 }
//                 onChangeText={(text) => handleInputChange(item, text)}
//                 style={styles.input}
//                 inputStyle={styles.inputText}
//                 keyboardType="numeric"
//                 editable={!(item === 'total' || item === 'final total')} // Only `total` and `final total` are read-only
//               />
//             )}
//           />
//         </View>
